...
describe("pure credential model", () => {
  ...
  it("keeps 9L connection descriptors redacted and the blueprint at 46 ready items", () => {
    const actionStrings = {
    ...
    expect(blueprint).toMatchObject({ totalCount: 46, readyCount: 46, unresolvedCount: 0, complete: true });
  });
});
