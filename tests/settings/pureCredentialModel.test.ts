...
describe("pure credential model", () => {
  ...
  it("keeps 9L connection descriptors redacted and the blueprint at 44 ready items", () => {
    const actionStrings = {
    ...
    expect(blueprint).toMatchObject({ totalCount: 44, readyCount: 44, unresolvedCount: 0, complete: true });
  });
});
