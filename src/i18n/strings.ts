...
const PT_PT: UiStrings = {
  ...
  settingsDeviceProducerDesc: "Desktop Producer — Este dispositivo mantém o índice e gera embeddings.",
  settingsDeviceCompanionTitle: "Mobile Companion",
  settingsDeviceCompanionDesc: "Mobile Companion — Este dispositivo consome dados de pesquisa sincronizados. Os embeddings são gerados pelo Desktop Producer.",
