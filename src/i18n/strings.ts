...
export interface UiStrings {
  ...
  analysisSuggestedMetadataForCurrentNote: string;
  analysisSuggestedMetadataForPath: string;
  ...
  analysisBatchMetadataWrongNote: string;
  ...
  settingsAdvancedAnalysisSection: string;
  settingsAdvancedEmbeddingsSection: string;
  settingsAdvancedIndexSection: string;
  settingsAdvancedYamlSection: string;
  settingsAdvancedExclusionsSection: string;
  settingsDeviceRole: string;
  settingsDeviceProducerTitle: string;
  settingsDeviceProducerDesc: string;
  settingsDeviceCompanionTitle: string;
  settingsDeviceCompanionDesc: string;
  settingsDeviceUnconfiguredTitle: string;
  settingsDeviceUnconfiguredDesc: string;
  settingsDeviceRoleRecommended: string;
  settingsDeviceProducerOption: string;
  settingsDeviceCompanionOption: string;
  settingsDeviceConfirmRole: string;
  settingsDeviceUseAsCompanion: string;
  settingsDeviceMobileCompanionNotice: string;
  settingsDeviceRoleSaveError: string;
  settingsDeviceRoleSavedNotice: string;
  settingsDeviceDesktopProducerTitle: string;
  settingsDeviceMobileProducerTitle: string;
  settingsDeviceDesktopCompanionTitle: string;
  settingsDeviceMobileCompanionTitle: string;
  settingsDeviceTemporaryStatus: string;
  settingsDeviceLegacyDesktopNotice: string;
  settingsDeviceLegacyMobileNotice: string;
  settingsDeviceConfirmProducerRole: string;
  settingsDeviceConfirmCompanionRole: string;
  settingsDeviceConfirmRoleError: string;
  settingsDeviceConfirmRoleSuccess: string;
  settingsDeviceChangeRoleAction: string;
  deviceRoleChangeModalTitle: string;
  deviceRoleChangeToProducerTitle: string;
  deviceRoleChangeToCompanionTitle: string;
  deviceRoleChangeActiveProducerWarningTitle: string;
  deviceRoleChangeActiveProducerWarning: string;
  deviceRoleChangeStandbyProducerNotice: string;
  deviceRoleChangeToProducerNotice: string;
  deviceRoleChangeConfirmButton: string;
  deviceRoleChangeCancelButton: string;
  deviceRoleChangeSuccess: string;
  deviceRoleChangeError: string;
  deviceRoleChangeMobileProducerNotSupported: string;
  settingsCompanionModeActive: string;
  settingsCompanionModeDesc: string;
  ...
  settingsBinaryCopyState: string;
  settingsBinaryMaintenanceState: string;
  settingsBinaryMaintenanceActive: string;
  settingsBinaryMaintenanceInactive: string;
  settingsBinaryStatusNotChecked: string;
  ...
  settingsBinaryReadReason: string;
...
const PT_PT: UiStrings = {
  ...
  mainNoticeNoLocalEmbeddings: "Ainda não existem embeddings. Gera primeiro com 'Gerar embeddings'.",
  ...
  warnProviderMismatch: "Os embeddings existentes foram gerados com outro provider ou modelo. Atualize os embeddings antes de usar a pesquisa semântica.",
  warnModelMismatch: "Os embeddings existentes foram gerados com outro provider ou modelo. Atualize os embeddings antes de usar a pesquisa semântica.",
  ...
  settingsSearchDataSection: "Cache de pesquisa rápida",
  settingsIndexDiagnosticsSection: "Diagnóstico do índice",
  settingsAdvancedAnalysisSection: "Ajuste avançado da análise IA",
  settingsAdvancedEmbeddingsSection: "Ajuste avançado dos embeddings",
  settingsAdvancedIndexSection: "Ajuste avançado do índice",
  settingsAdvancedYamlSection: "Propriedades YAML avançadas",
  settingsAdvancedExclusionsSection: "Filtros avançados de exclusão",
  settingsDeviceRole: "Função do dispositivo",
  settingsDeviceProducerTitle: "Desktop Producer",
  settingsDeviceProducerDesc: "Este dispositivo mantém o índice de pesquisa e gera embeddings.",
  settingsDeviceCompanionTitle: "Mobile Companion",
  settingsDeviceCompanionDesc: "Este dispositivo consome dados de pesquisa sincronizados. Os embeddings são gerados pelo Desktop Producer.",
  settingsDeviceUnconfiguredTitle: "Não configurada",
  settingsDeviceUnconfiguredDesc: "Escolha como o Lina deve utilizar este dispositivo.",
  settingsDeviceRoleRecommended: "Recomendado",
  settingsDeviceProducerOption: "Producer",
  settingsDeviceCompanionOption: "Companion",
  settingsDeviceConfirmRole: "Confirmar função do dispositivo",
  settingsDeviceUseAsCompanion: "Utilizar como Companion",
  settingsDeviceMobileCompanionNotice: "O Lina utiliza este dispositivo como companion leve. Os índices de pesquisa e embeddings são mantidos por um dispositivo Producer.",
  settingsDeviceRoleSaveError: "Falha ao guardar a função do dispositivo",
  settingsDeviceRoleSavedNotice: "Função do dispositivo configurada com sucesso.",
  settingsDeviceDesktopProducerTitle: "Desktop Producer",
  settingsDeviceMobileProducerTitle: "Mobile Producer",
  settingsDeviceDesktopCompanionTitle: "Desktop Companion",
  settingsDeviceMobileCompanionTitle: "Mobile Companion",
  settingsDeviceTemporaryStatus: "Temporário",
  settingsDeviceLegacyDesktopNotice: "O Lina está atualmente a utilizar a função automática anterior para desktop. Confirme esta função para a tornar explícita neste dispositivo.",
  settingsDeviceLegacyMobileNotice: "Confirme a função de Companion para este dispositivo para concluir a configuração.",
  settingsDeviceConfirmProducerRole: "Confirmar função de Producer",
  settingsDeviceConfirmCompanionRole: "Confirmar função de Companion",
  settingsDeviceConfirmRoleError: "Falha ao confirmar a função do dispositivo",
  settingsDeviceConfirmRoleSuccess: "Função do dispositivo confirmada com sucesso.",
  settingsDeviceChangeRoleAction: "Alterar papel do dispositivo…",
  deviceRoleChangeModalTitle: "Alterar papel do dispositivo",
  deviceRoleChangeToProducerTitle: "Alterar para Produtor",
  deviceRoleChangeToCompanionTitle: "Alterar para Companion",
  deviceRoleChangeActiveProducerWarningTitle: "Aviso: Dispositivo é o Produtor Ativo",
  deviceRoleChangeActiveProducerWarning: "Este dispositivo é atualmente o Produtor Ativo. Alterá-lo para Companion irá interromper a manutenção do índice e embeddings partilhados até que outro Produtor fique ativo.",
  deviceRoleChangeStandbyProducerNotice: "Este dispositivo deixará de funcionar como Produtor em espera e passará a funcionar exclusivamente como consumidor de índices e embeddings (Companion).",
  deviceRoleChangeToProducerNotice: "Este dispositivo será configurado como Produtor, ficando designado para manter os índices e embeddings do cofre. Se já existir outro Produtor Ativo no cofre, este dispositivo funcionará em modo de espera até que a autoridade seja transferida.",
  deviceRoleChangeConfirmButton: "Confirmar alteração de papel",
  deviceRoleChangeCancelButton: "Cancelar",
  deviceRoleChangeSuccess: "Papel do dispositivo alterado com sucesso.",
  deviceRoleChangeError: "Falha ao alterar o papel do dispositivo",
  deviceRoleChangeMobileProducerNotSupported: "Dispositivos móveis não podem ser configurados como Produtor nesta versão.",
  ...
  settingsCredentialClearSuccess: "Opera\u00e7\u00e3o de limpeza da chave API conclu\u00edda.",
  ...
  settingsEnableEmbeddingsDesc: "Permite pesquisar notas pelo seu significado e contexto, além de palavras exatas.",
  ...
  settingsBinarySection: "Cache de aceleração da pesquisa",
  settingsBinaryExperimentalWarning: "Otimização de velocidade em memória. O índice JSONL é sempre preservado para compatibilidade e recuperação.",
  settingsBinaryPreference: "Usar cache rápida quando disponível",
  settingsBinaryPreferenceDesc: "Prefere a cache de alta velocidade quando está atualizada. Caso contrário, o Lina continua a usar o índice padrão.",
  settingsBinaryPrefer: "Preferir cache rápida",
  settingsBinaryMaintain: "Manter cache rápida após atualizar embeddings",
  settingsBinaryMaintainDesc: "Depois de atualizar os embeddings, atualiza a cache rápida em segundo plano.",
  settingsBinaryCheck: "Verificar cache rápida", settingsBinaryCreate: "Criar/atualizar cache rápida", settingsBinaryRemove: "Remover cache rápida",
  settingsBinaryRemoveConfirm: "Remover a cache rápida? O índice padrão continuará disponível.",
  settingsBinaryWorking: "Operação da cache rápida em curso...", settingsBinarySuccess: "Operação da cache rápida concluída.", settingsBinaryError: "Não foi possível concluir a operação na cache rápida.", settingsBinaryAutomaticWarning: "A cache rápida não foi atualizada. O índice padrão continua disponível.",
  settingsBinaryStatus: "Estado", settingsBinaryCopyState: "Estado da cópia", settingsBinaryMaintenanceState: "Manutenção automática", settingsBinaryMaintenanceActive: "ativa", settingsBinaryMaintenanceInactive: "desativada", settingsBinaryStatusNotChecked: "ainda não verificada", settingsBinaryStatusDisabled: "desativada", settingsBinaryStatusAbsent: "inexistente", settingsBinaryStatusValid: "válida", settingsBinaryStatusOutdated: "desatualizada", settingsBinaryStatusIncomplete: "incompleta", settingsBinaryStatusInvalid: "inválida", settingsBinaryStatusUnsupported: "não suportada", settingsBinaryStatusLegacyManifest: "índice legado: reconstrua ou atualize os embeddings antes de criar a cópia binária",
  ...
  settingsBatchSizeDesc: "Número máximo de trechos de notas a processar em cada execução.",
  ...
  semanticEmbeddingsUnavailableGenerate: "Embeddings indisponíveis ou inválidos. Gera embeddings antes de usar a pesquisa semântica.",
  semanticEmbeddingsMissingGenerate: "Ainda não existem embeddings. Gera embeddings primeiro.",
  ...
  semanticQueryDimensionMismatch: "A dimensão do embedding da pesquisa não coincide com a dos embeddings do índice. Os embeddings parecem desatualizados. Gera embeddings novamente.",
...
const EN: UiStrings = {
  ...
  settingsDeviceRole: "Device role",
  settingsDeviceProducerTitle: "Desktop Producer",
  settingsDeviceProducerDesc: "This device maintains the search index and generates embeddings.",
  settingsDeviceCompanionTitle: "Mobile Companion",
  settingsDeviceCompanionDesc: "This device uses synchronized search data generated by your Desktop Producer.",
  settingsDeviceUnconfiguredTitle: "Not configured",
  settingsDeviceUnconfiguredDesc: "Choose how Lina should use this device.",
  settingsDeviceRoleRecommended: "Recommended",
  settingsDeviceProducerOption: "Producer",
  settingsDeviceCompanionOption: "Companion",
  settingsDeviceConfirmRole: "Confirm device role",
  settingsDeviceUseAsCompanion: "Use as Companion",
  settingsDeviceMobileCompanionNotice: "Lina uses this device as a lightweight companion. Search indexes and embeddings are maintained by a Producer device.",
  settingsDeviceRoleSaveError: "Failed to save device role",
  settingsDeviceRoleSavedNotice: "Device role configured successfully.",
  settingsDeviceDesktopProducerTitle: "Desktop Producer",
  settingsDeviceMobileProducerTitle: "Mobile Producer",
  settingsDeviceDesktopCompanionTitle: "Desktop Companion",
  settingsDeviceMobileCompanionTitle: "Mobile Companion",
  settingsDeviceTemporaryStatus: "Temporary",
  settingsDeviceLegacyDesktopNotice: "Lina is currently using the previous automatic desktop role. Confirm this role to make it explicit for this device.",
  settingsDeviceLegacyMobileNotice: "Confirm Companion for this device to complete the role setup.",
  settingsDeviceConfirmProducerRole: "Confirm Producer role",
  settingsDeviceConfirmCompanionRole: "Confirm Companion role",
  settingsDeviceConfirmRoleError: "Failed to confirm device role",
  settingsDeviceConfirmRoleSuccess: "Device role confirmed successfully.",
  settingsDeviceChangeRoleAction: "Change device role…",
  deviceRoleChangeModalTitle: "Change device role",
  deviceRoleChangeToProducerTitle: "Change to Producer",
  deviceRoleChangeToCompanionTitle: "Change to Companion",
  deviceRoleChangeActiveProducerWarningTitle: "Warning: Device is Active Producer",
  deviceRoleChangeActiveProducerWarning: "This device is currently the Active Producer. Changing it to Companion will stop shared index and embedding maintenance until another Producer becomes active.",
  deviceRoleChangeStandbyProducerNotice: "This device will switch from Standby Producer to Companion, acting exclusively as a consumer of search assets.",
  deviceRoleChangeToProducerNotice: "This device will be configured as Producer, designated to maintain shared vault search assets. If another Active Producer already exists, this device will operate in standby mode until ownership is transferred.",
  deviceRoleChangeConfirmButton: "Confirm role change",
  deviceRoleChangeCancelButton: "Cancel",
  deviceRoleChangeSuccess: "Device role changed successfully.",
  deviceRoleChangeError: "Failed to change device role",
  deviceRoleChangeMobileProducerNotSupported: "Mobile devices cannot be configured as Producer in this version.",
  ...
  settingsCredentialClearSuccess: "API-key clear operation completed.",
  ...
  settingsBinaryCheck: "Check fast cache", settingsBinaryCreate: "Create/update fast cache", settingsBinaryRemove: "Remove fast cache",
  settingsBinaryRemoveConfirm: "Remove fast search cache? The standard index will remain available.",
  settingsBinaryWorking: "Cache operation in progress...", settingsBinarySuccess: "Fast search cache operation completed.", settingsBinaryError: "Could not complete fast search cache operation.", settingsBinaryAutomaticWarning: "Fast cache was not updated. The standard index remains available.",
  settingsBinaryStatus: "Status", settingsBinaryCopyState: "Copy state", settingsBinaryMaintenanceState: "Automatic maintenance", settingsBinaryMaintenanceActive: "enabled", settingsBinaryMaintenanceInactive: "disabled", settingsBinaryStatusNotChecked: "not checked yet", settingsBinaryStatusDisabled: "disabled", settingsBinaryStatusAbsent: "absent", settingsBinaryStatusValid: "valid", settingsBinaryStatusOutdated: "outdated", settingsBinaryStatusIncomplete: "incomplete", settingsBinaryStatusInvalid: "invalid", settingsBinaryStatusUnsupported: "unsupported", settingsBinaryStatusLegacyManifest: "legacy index: rebuild or update embeddings before creating the binary copy",
